# Prompt-related Files Audit (20260227-190529)

## Scope
Prompt text, prompt assembly logic, runtime prompt resolution, refine prompt stitching, API prompt transport, and prompt-linked scripts/docs entry.
